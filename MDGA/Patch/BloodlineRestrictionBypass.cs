...
namespace MDGA.Patch
{
    ...
    internal static class BloodlineRestrictionBypass
    {
        ...
        private static BlueprintScriptableObject _crossSecondarySelection; // 交叉血统的次要血统选择
        private static BlueprintScriptableObject _secondBloodlineSelection; // 神话“第二血统”
        ...
        internal static void Install()
        {
            ...
            PatchCanSelectAnything();          // 作用于我们的目标选择
            PatchIFeatureSelectionCanSelect();  // 精细白名单逻辑
        ...
        // 枚举 LevelUpState 中存放的所有 FeatureSelectionState，以找出当前会话中已选择的条目
